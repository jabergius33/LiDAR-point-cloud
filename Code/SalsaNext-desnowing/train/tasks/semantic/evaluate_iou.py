...
def eval(test_sequences,splits,pred):
    ...
    for scan_file, label_file, pred_file in zip(scan_names, label_names, pred_names):
        ...
        #import collections #JESPER H
        #print("pred.sem_label",collections.Counter(pred.sem_label)) #JESPER H
        #print("u_pred_sem",collections.Counter(u_pred_sem))#JESPER H
        #assert False  #JESPER H
