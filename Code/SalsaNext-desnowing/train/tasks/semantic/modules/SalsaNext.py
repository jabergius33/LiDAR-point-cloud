...
## File is altered for binary classifcation, (Johan Bergius) ##
import imp
...
class SalsaNext(nn.Module):
    def __init__(self, nclasses):
        ...
        self.resBlock2 = ResBlock(2 * 32, 4 * 32, 0.2, pooling=True)

        
        self.resBlock5 = ResBlock(4 * 32, 4 * 32, 0.2, pooling=False)
    ...
    def forward(self, x):
        ...
        down5c = self.resBlock5(down1c)

 
        up2e = self.upBlock3(down5c, down1b)
        up1e = self.upBlock4(up2e, down0b)
        
        contextOut = self.downCntx3(up1e)
        logits = self.logits(contextOut)
