...
#2022 Johan Bergius.
## Modifications: network architecture is reduced and network output is altered (code is updated to work on Spconv 2.x)
...
class UpBlock(nn.Module): ## Asymmetrical UpSample Block
...
class ReconBlock(nn.Module): ## Dimension-Decomposition based Context Modeling
    def __init__(self, in_filters, out_filters, kernel_size=(3, 3, 3), stride=1, indice_key=None):
...
class Asymm_3d_spconv(nn.Module):
    ...
    def forward(self, voxel_features, coors, batch_size, _):
